...
public class MatrixService {
	...
	public void multiplyBy3x3(float[] matrixA, float[] matrixB) {
	    ...
	    for (int i=0; i<9; i++) matrixB[i]=new_matrix[i];
	}
	...
	public void rotateAboutZAxis3x3(float[] matrix, float degrees) {
		...
		rotationMatrix[0] = cosine;
		rotationMatrix[1] = sine;
		rotationMatrix[3] = -sine;
		rotationMatrix[4] = cosine;
